...
// Sekarang memakai StarNova API (API milik owner). BOT_API_KEY = owner key
// StarNova (limit TAK TERBATAS) — buat via: npm run owner-key di starnova-dashboard.
// Ganti nilai default lewat env agar tidak hardcode di repo.
export function apiCredentials() {
    return {
        baseUrl: process.env.BOT_API_BASEURL || "https://dash.starnova.my.id",
